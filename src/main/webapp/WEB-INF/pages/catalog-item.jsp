...
<head>
    <meta charset="utf-8">
    <title>ЯМА - Каталог | Ноутбук Sony Vaio SVT1311MR1S</title>
...
<ol class="breadcrumb container">
    <li><a href="http://localhost:8080/Catalog">Каталог</a></li>
    <li class="active"> Ноутбук Sony Vaio SVT1311MR1S</li>
</ol>
